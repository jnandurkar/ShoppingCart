...
import com.shoppingcart.rest.controller.bill.beans.ProductInfoForBill;
import com.shoppingcart.rest.controller.product.beans.ProductInfo;
import com.shoppingcart.service.BillService;
import com.shoppingcart.service.ProductService;
import com.shoppingcart.util.BillStatus;
import com.shoppingcart.util.ProductCategory;
...
public class SampleDataSetupRunner implements CommandLineRunner {
	...
	public void setupBillData() {
		...
		Bill o1 = billService.createBill(new Bill(0.0, 0, BillStatus.IN_PROGRESS,0));
	...
	private void setUpProductData() {
		productService.createProduct(new ProductInfo("ORS-0001", 20.0, "Tomato", ProductCategory.Regular));
		productService.createProduct(new ProductInfo("ORS-0002", 30.0, "Onion", ProductCategory.Premium));
		productService.createProduct(new ProductInfo("ORS-0004", 50.0, "Bread", ProductCategory.Regular));
		productService.createProduct(new ProductInfo("ORS-0005", 60.0, "Apples", ProductCategory.Premium));
		productService.createProduct(new ProductInfo("ORS-0007", 80.0, "Strawberry", ProductCategory.Regular));
		productService.createProduct(new ProductInfo("ORS-0008", 90.0, "Apricot", ProductCategory.Premium));
		productService.createProduct(new ProductInfo("ORS-0009", 100.0, "Raisins", ProductCategory.Premium));
	}
}
*/